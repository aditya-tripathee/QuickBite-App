...
function Footer() {
  return (
   <div className='text-gray-900 pt-15 md:pt-5 grid grid-cols-2 gap-2  mt-3 px-6 justify-center items-between md:flex md:justify-evenly  h-[500px] md:h-[250px] w-full bg-green-800'>
